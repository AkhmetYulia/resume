  ...
  res.render('education', {
    ...
    main: {
      education: [
        ...
        {
          name: 'Академія адвокатури України (ААУ)',
          isEnd: true,
        },
        {
  ...
  res.render('task21', {
    ...
    nested_display: {
      ...
      children_display: {
        ...
        text: 'tags that have been identified as deprecated and not recommended for use in HTML vers 5',
        button: {
          text: 'Орen',
        },
      },
